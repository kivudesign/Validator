...
//     * @return $this
//     */
//    function min(int $rule_values=0): SCHString
//    {
...
//     * @return $this
//     */
//    function max(int $rule_values=1): SCHString
//    {
